...
const root = await mkdtemp(join(tmpdir(), "kontrol-apply-patch-"));
...
const outside = await mkdtemp(join(tmpdir(), "kontrol-apply-patch-outside-"));
...
const splitHunkRoot = await mkdtemp(join(tmpdir(), "kontrol-apply-patch-split-hunk-"));
await writeFile(
...
const trailingSpaceRoot = await mkdtemp(join(tmpdir(), "kontrol-apply-patch-trailing-space-"));
...
const overwriteRoot = await mkdtemp(join(tmpdir(), "kontrol-apply-patch-overwrite-"));
...
const noNewlineRoot = await mkdtemp(join(tmpdir(), "kontrol-apply-patch-newline-"));
...
const eofRoot = await mkdtemp(join(tmpdir(), "kontrol-apply-patch-eof-"));
...
const lenientRoot = await mkdtemp(join(tmpdir(), "kontrol-apply-patch-lenient-"));
