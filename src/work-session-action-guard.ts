...
export const TOOL_TO_ACTION_CLASS: Record<string, ActionClass> = {
  ...
  "devdesktop-read": "read_files",
  "devdesktop-grep": "read_files",
  "devdesktop-glob": "read_files",
  "devdesktop-write": "edit_files",
  "devdesktop-edit": "edit_files",
  bash: "run_commands",
  "devdesktop-shell": "run_commands",
  exec_command: "run_commands",
  submit_for_review: "resubmit",
  "devdesktop-submit-work-to-webui": "resubmit",
